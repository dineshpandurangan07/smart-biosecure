...
export const seedInMemory = async () => {
  try {
    ...
    const vaccinationsList = [
      ...
      { animalTag: 'PIG-0037', vaccineName: 'Swine Influenza Shot', diseaseTargeted: 'H1N1 / H3N2', doseNumber: 1, dateAdministered: null, nextDueDate: expiredDate, status: 'Overdue' },
    ...
    console.error(`Error in seeding in-memory database: ${error.message}`);
    throw error;
  }
};
